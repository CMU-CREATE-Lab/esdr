...
describe("REST API", function() {
   ...
   const feed1Conductivity10_2633 = requireNew('./fixtures/get-tile-feed1-conductivity-10_2633.json');
   const feed2Temperature9_4886 = requireNew('./fixtures/get-tile-feed2-temperature-9_4886.json');
   ...
   describe("Feeds", function() {
      describe("Get Tile", function() {
            ...
            [
               {
                  ...
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed1.id + "/channels/conductivity/tiles/10.2633";
                  },
                  expectedHttpStatus : httpStatus.OK,
                  expectedStatusText : 'success',
                  expectedResponseData : feed1Conductivity10_2633
               },
               {
                  description : "Should fail to get a tile from a private feed without authentication",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                  },
               ...
               {
                  description : "Should fail to get a tile for a feed with an invalid ID (valid ID plus extra non-numeric characters appended)",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed1.id + "abc" + "/channels/temperature/tiles/9.4886";
                  },
         ...
         describe("OAuth2 authentication", function() {
            ...
            [
               {
                  description : "Should be able to get a tile from a public feed with valid authentication",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed1.id + "/channels/conductivity/tiles/10.2633";
                  },
                  headers : function() {
               ...
               {
                  description : "Should be able to get a tile from a public feed with invalid authentication",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed1.id + "/channels/conductivity/tiles/10.2633";
                  },
                  headers : function() {
               ...
               {
                  description : "Should be able to get a tile from a private feed with valid authentication",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                  },
                  headers : function() {
                  ...
                  expectedHttpStatus : httpStatus.OK,
                  expectedStatusText : 'success',
                  expectedResponseData : feed2Temperature9_4886
               },
               {
                  description : "Should fail to get a tile from a private feed with invalid authentication",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                  },
                  headers : function() {
               ...
               {
                  description : "Should fail to get a tile from a private feed with valid authentication, but for the wrong user",
                  url : function() {
                     return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                  },
                  headers : function() {
         ...
         describe("API Key Authentication", function() {
            ...
            describe("Feed API Key in the request header", function() {
               ...
               [
                  ...
                  {
                     description : "Should be able to get a tile from a public feed with valid read-only authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed1.id + "/channels/conductivity/tiles/10.2633";
                     },
                     headers : function() {
                  ...
                  {
                     description : "Should be able to get a tile from a private feed with valid read-only authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                     },
                     headers : function() {
                  ...
                  {
                     description : "Should fail to get a tile from a private feed with valid read-write authentication, but for the wrong feed",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                     },
                     headers : function() {
                  ...
                  {
                     description : "Should fail to get a tile from a private feed with valid read-only authentication, but for the wrong feed",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed2.id + "/channels/temperature/tiles/9.4886";
                     },
                     headers : function() {
            ...
            describe("Feed API Key in the URL", function() {
               ...
               [
                  {
                     description : "Should be able to get a tile from a public feed with valid read-write authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed1.apiKey + "/channels/conductivity/tiles/10.2633";
                     },
                     expectedHttpStatus : httpStatus.OK,
                     expectedStatusText : 'success',
                     expectedResponseData : feed1Conductivity10_2633
                  },
                  {
                     description : "Should be able to get a tile from a public feed with valid read-write authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed1.apiKeyReadOnly + "/channels/conductivity/tiles/10.2633";
                     },
                     expectedHttpStatus : httpStatus.OK,
                     expectedStatusText : 'success',
                     expectedResponseData : feed1Conductivity10_2633
                  ...
                  {
                     description : "Should be able to get a tile from a private feed with valid read-write authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed2.apiKey + "/channels/temperature/tiles/9.4886";
                     },
                     expectedHttpStatus : httpStatus.OK,
                     expectedStatusText : 'success',
                     expectedResponseData : feed2Temperature9_4886
                  },
                  {
                     description : "Should be able to get a tile from a private feed with valid read-only authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + feed2.apiKeyReadOnly + "/channels/temperature/tiles/9.4886";
                     },
                     expectedHttpStatus : httpStatus.OK,
                     expectedStatusText : 'success',
                     expectedResponseData : feed2Temperature9_4886
                  ...
                  {
                     description : "Should fail to get a tile with invalid authentication",
                     url : function() {
                        return ESDR_FEEDS_API_URL + "/" + UNKNOWN_FEED_API_KEY + "/channels/temperature/tiles/9.4886";
                     },
                     expectedHttpStatus : httpStatus.NOT_FOUND,
                     expectedStatusText : 'error',
                     expectedResponseData : null
