            ...
            describe("API Key Authentication", function() {
               describe("Feed API Key in the request header", function() {
                  ...
                  [
                     ...
                     {
                        description : "Should fail to upload to a public feed using the wrong feed's apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed1.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a private feed using the wrong feed's apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed2.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a public feed using the wrong feed's read-only apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed1.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a private feed using the wrong feed's read-only apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed2.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a public feed using an invalid feed apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed1.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a private feed using an invalid feed apiKey to authenticate",
                        url : function() {
                           return ESDR_FEEDS_API_URL + "/" + feed2.id;
                        },
                        headers : function() {
                     ...
                     {
                        description : "Should fail to upload to a feed using a valid feed apiKey but an invalid feed ID",
                        url : function() {
