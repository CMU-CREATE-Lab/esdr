...
describe("REST API", function() {
   ...
   const feed1MostRecentData = requireNew('./fixtures/most-recent-single-channel-feed1-response-data.json');
   const feed2MostRecentData = requireNew('./fixtures/most-recent-single-channel-feed2-response-data.json');
