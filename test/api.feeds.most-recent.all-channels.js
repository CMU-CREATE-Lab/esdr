...
describe("REST API", function() {
   ...
   const feed1MostRecentData = requireNew('./fixtures/most-recent-all-channels-feed1-response-data.json');
   const feed2MostRecentData = requireNew('./fixtures/most-recent-all-channels-feed2-response-data.json');
