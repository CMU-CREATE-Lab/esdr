...
SequenceNumber=function(){};SequenceNumber.getNext=function(){console.log("SequenceNumber is deprecated");return 1};document.addEventListener("DOMContentLoaded",function(){var a=a||window.parent;a.grapherLoad&&a.grapherLoad()},!1);"use strict";cr=cr||{};cr.TimeConstants=function(){};cr.TimeConstants.SECONDS_IN_HOUR=3600;cr.TimeConstants.SECONDS_IN_DAY=24*cr.TimeConstants.SECONDS_IN_HOUR;cr.TimeConstants.SECONDS_IN_WEEK=7*cr.TimeConstants.SECONDS_IN_DAY;cr.TimeConstants.SECONDS_IN_YEAR=31556926;
cr.TimeConstants.SECONDS_IN_DECADE=10*cr.TimeConstants.SECONDS_IN_YEAR;cr.TimeConstants.SECONDS_IN_CENTURY=10*cr.TimeConstants.SECONDS_IN_DECADE;cr.TimeConstants.SECONDS_IN_MONTH=Math.round(cr.TimeConstants.SECONDS_IN_YEAR/12);Object.freeze(cr.TimeConstants);
