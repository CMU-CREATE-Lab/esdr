...
this.minorTickWidthPixels=cr.GraphAxis.Constants.DEFAULT_MINOR_TICK_WIDTH_PIXELS;this.hasMinRange=!1;this.minRange=cr.GraphAxis.Constants.DEFAULT_MIN_RANGE;this.hasMaxRange=!1;this.maxRange=cr.GraphAxis.Constants.DEFAULT_MAX_RANGE;this.hasMaxConstraint=!1;this.maxConstraint;this.hasMinConstraint=!1;this.minConstraint;this._begin;this._length;this._scale;this._resolutionScale=window.devicePixelRatio||1;this.clampToRange();this.resize();this.cursorSelected=this.isCursorDragging=this.isXAxisDragging=
!1;a=$("#"+this._canvas.id);a.mousedown(this,this.mousedown);a.mousemove(this,this.mousemove);a.mouseup(this,this.mouseup);a.on("mousewheel",this,this.mousewheel);this._previousTouches=null;this.touchUtils=new cr.TouchUtils;a.bind("touchstart",this,this.touchstart);a.bind("touchmove",this,this.touchmove);a.bind("touchend",this,this.touchend);a.bind("touchcancel",this,this.touchend);null==f&&(this.grapher=__grapher__);this.axisChangeListeners=[]};
cr.GraphAxis.Constants={DEFAULT_MAJOR_TICK_MIN_SPACING_PIXELS:30,DEFAULT_MAJOR_TICK_WIDTH_PIXELS:8,DEFAULT_MINOR_TICK_MIN_SPACING_PIXELS:10,DEFAULT_MINOR_TICK_WIDTH_PIXELS:3,DEFAULT_MIN_RANGE:-1E100,DEFAULT_MAX_RANGE:1E100};Object.freeze(cr.GraphAxis.Constants);
cr.GraphAxis.prototype.mousedown=function(a){var b=a.data;b.lastCursorX=b.project1D(b.cursorX);cr.MouseState.setLastMouse(a);cr.MouseState.setIsMouseDown(!0);var c=b.project1D(b.cursorX)-10,d=b.project1D(b.cursorX)+10,e=Math.floor(b._div.clientHeight/2),f=b._div.clientHeight;c<=a.offsetX&&d>=a.offsetX&&e<=a.offsetY&&f>=a.offsetY&&(b.cursorSelected=!0);return!1};
cr.GraphAxis.prototype.mousemove=function(a){var b=a.data;b.mouseDown=cr.MouseState.isMouseDown();if(b.mouseDown&&("undefined"!=typeof a.buttons&&0==a.buttons||"undefined"!=typeof a.which&&0==a.which))b.mouseup(a);else return b.lastMouse=cr.MouseState.getLastMouse(),b.mouseDown&&b.lastMouse&&(b.isXAxis?b.cursorX&&b.cursorSelected?b.handleCursorDragging(a):b.translatePixels(a.clientX-b.lastMouse.clientX):b.translatePixels(b.lastMouse.clientY-a.clientY)),cr.MouseState.setLastMouse(a),!1};
cr.GraphAxis.prototype.handleCursorDragging=function(a){a.data.isCursorDragging=!0;a=this.cursorX+(a.offsetX-this.lastCursorX)/(this._canvas.width/this._resolutionScale/(this._max-this._min));this.lastCursorX=this.project1D(a);this.setCursorPosition(a);this.grapher.scheduleUpdate()};
cr.GraphAxis.prototype.mouseup=function(a){var b=a.data;b.lastMouse=cr.MouseState.getLastMouse();b.lastMouse&&!b.isXAxisDragging&&b.lastCursorX&&(b.setCursorPosition(b.cursorX+(a.offsetX-b.lastCursorX)/(b._canvas.width/b._resolutionScale/(b._max-b._min))),b.grapher.scheduleUpdate());cr.MouseState.setLastMouse(null);b.isXAxisDragging=!1;b.cursorSelected=!1;b.isCursorDragging=!1;cr.MouseState.setIsMouseDown(!1);b.publishAxisChangeEvent()};
cr.GraphAxis.prototype.mousewheel=function(a){var b=a.data,c=100*cr.Util.normalizeScrollDelta(a);b.isXAxis?b.zoomAboutX(a.offsetX,Math.pow(1.0005,c)):b.zoomAboutY(a.offsetY,Math.pow(1.0005,c));return!1};cr.GraphAxis.prototype.touchstart=function(a){var b=a.data;b._previousTouches=cr.TouchUtils.filterTouchesForElement(a.originalEvent.touches,b._canvas.id).slice(0,2);2<=b._previousTouches.length&&(b._touchTargetPagePosition=cr.TouchUtils.getElementPagePosition(b._canvas));return!1};
...
d))):(b.translatePixels(d.y-c.y),b.touchUtils.isYPinch(a)&&b.touchUtils.isYPinch(b._previousTouches)&&(c=c.y-b._touchTargetPagePosition.y,d=b.touchUtils.ySpan(a)/b.touchUtils.ySpan(b._previousTouches),b.zoomAboutY(c,d)))}b._previousTouches=b.touchUtils.copyTouches(a);return!1};
cr.GraphAxis.prototype.touchend=function(a){a=a.data;if(!a.isXAxisDragging){var b=a.touchUtils.centroid(a._previousTouches);a.lastCursorX=a.project1D(a.cursorX);a.setCursorPosition(a.cursorX+(b.x-a.lastCursorX)/(a._canvas.width/a._resolutionScale/(a._max-a._min)));a.grapher.scheduleUpdate()}a._previousTouches=null;return a.isXAxisDragging=!1};
cr.GraphAxis.prototype.translatePixels=function(a){if(0!=a){if(this.isXAxis){this.isXAxisDragging=!0;var b=this._canvas.width/this._resolutionScale/(this._max-this._min)}else b=this._canvas.height/this._resolutionScale/(this._max-this._min);this._min-=a/b;this._max-=a/b;this.limitView()}};
...
cr.GraphAxis.prototype.getIsXAxisDragging=function(){return this.isXAxisDragging};cr.GraphAxis.prototype.getIsCursorDragging=function(){return this.isCursorDragging};cr.GraphAxis.prototype.setIsXAxisDragging=function(a){(this.isXAxisDragging=a)||cr.MouseState.setLastMouse(null)};cr.GraphAxis.prototype.setIsCursorDragging=function(a){(this.isCursorDragging=a)||cr.MouseState.setLastMouse(null)};"use strict";cr=cr||{};
...
this.div.style.height;this.canvas2d.style.position="absolute";this.div.appendChild(this.canvas2d);this.ctx=this.canvas2d.getContext("2d");var a=$("#"+this.canvas2d.id);a.mousedown(this,this.mousedown);a.mousemove(this,this.mousemove);a.mouseup(this,this.mouseup);a.on("mousewheel",this,this.mousewheel);a=$("#"+this.canvas3d.id);a.mousedown(this,this.mousedown);a.mousemove(this,this.mousemove);a.mouseup(this,this.mouseup);a.on("mousewheel",this,this.mousewheel)};
cr.SeriesPlotContainer.prototype.mousedown=function(a){var b=a.data;cr.MouseState.setLastMouse(a);cr.MouseState.setIsMouseDown(!0);var c=a.offsetX-5,d=a.offsetX+5,e=a.offsetY+5,f=a.offsetY-5;Object.keys(b._plots).forEach(function(g){g=b._plots[g];var h={};h.xmin=g.xAxis.pixelToX(c);h.xmax=g.xAxis.pixelToX(d);h.ymin=g.yAxis.pixelToY(e);h.ymax=g.yAxis.pixelToY(f);if(h=g.tlayer.search(h))g.xAxis.setCursorPosition(h.x),g.publishDataPoint(h,a),b.grapher.scheduleUpdate()});return!1};
cr.SeriesPlotContainer.prototype.mousemove=function(a){var b=a.data;b.mouseDown=cr.MouseState.isMouseDown();if(b.mouseDown&&("undefined"!=typeof a.buttons&&0==a.buttons||"undefined"!=typeof a.which&&0==a.which))b.mouseup(a);else{if(b._xAxis.getIsCursorDragging())return b._xAxis.handleCursorDragging(a),cr.MouseState.setLastMouse(a),!1;b.lastMouse=cr.MouseState.getLastMouse();if(b.mouseDown&&b.lastMouse){var c={},d={};Object.keys(b._plots).forEach(function(e){e=b._plots[e];e.xAxis.id in c||(e.xAxis.translatePixels(a.clientX-
b.lastMouse.clientX),c[e.xAxis.id]=!0);e.yAxis.id in d||(e.yAxis.translatePixels(b.lastMouse.clientY-a.clientY),d[e.yAxis.id]=!0)});cr.MouseState.setLastMouse(a);return!1}var e=a.offsetX-5,f=a.offsetX+5,g=a.offsetY+5,h=a.offsetY-5;Object.keys(b._plots).every(function(c){var d=b._plots[c],m={};m.xmin=d.xAxis.pixelToX(e);m.xmax=d.xAxis.pixelToX(f);m.ymin=d.yAxis.pixelToY(g);m.ymax=d.yAxis.pixelToY(h);if(m=d.tlayer.search(m))return b.mouseoverHighlightPoint={point:m,plotKey:c},b.grapher.scheduleUpdate(),
d.publishDataPoint(m,a),!1;d.publishDataPoint(null);b.mouseoverHighlightPoint&&(b.mouseoverHighlightPoint=null,b.grapher.scheduleUpdate());return!0})}};cr.SeriesPlotContainer.prototype.mouseup=function(a){a=a.data;cr.MouseState.setLastMouse(null);cr.MouseState.setIsMouseDown(!1);a._xAxis.setIsXAxisDragging(!1);a._xAxis.setIsCursorDragging(!1)};
...
cr.SeriesPlotContainer.prototype.update=function(){this.usewebgl?this.glb&&this.glb.clear():this.ctx.clearRect(0,0,this.ctx.canvas.width,this.ctx.canvas.height);var a={},b;for(b in this._plots){var c=this._plots[b];c.update();a[c.yAxis.id]=c.yAxis}if(this._isAutoscaleEnabled){var d={},e=this._xAxis.getRange();for(b in this._plots){var c=this._plots[b],f=c.yAxis,g=d[f.id],c=c.tlayer.getMinMaxValue(e);null!=c&&("undefined"===typeof g?(g=c,d[f.id]=g):(g.min=Math.min(c.min,g.min),g.max=Math.max(c.max,
g.max)))}}for(var h in a)f=a[h],this._isAutoscaleEnabled&&(g=d[h],"undefined"!==typeof g&&null!=g&&(this._isAutoscalePaddingEnabled&&(g=this._padRange(g)),f.setRange(g.min,g.max))),f.update();this._needsUpdate=!1;for(b in this._plots)if(this._plots[b]._needsUpdate){this._needsUpdate=!0;break}this.drawHighlight();this.drawMidnightLines();this.drawHighlightPoints();this.drawMouseoverHighlightPoint()};
...
this.gl.viewport(0,0,this.canvas3d.width,this.canvas3d.height)};cr.SeriesPlotContainer.prototype.addPlot=function(a){var b=a.getId();this._plots[b]=a;this._plots[b].tlayer=new cr.DataStoreTileLayer(a.datasource,this.glb,this.ctx,this.usewebgl);this._plots[b].tlayer.usewebgl=this.usewebgl;this.grapher.scheduleUpdate()};
cr.SeriesPlotContainer.prototype.removePlot=function(a){var b=a.getId();this.highlightedPoints=this.highlightedPoints.filter(function(a){return a&&a.plotKey!=b});this.mouseoverHighlightPoint&&this.mouseoverHighlightPoint.plotKey==b&&(this.mouseoverHighlightPoint=null);delete this._plots[b];this.grapher.scheduleUpdate()};cr.SeriesPlotContainer.prototype.setSize=function(a,b){this.div.style.width=a+"px";this.div.style.height=b+"px";this.resize()};
...
cr.MidnightLine.prototype.shouldDrawMidnightLines=function(a){var b=a.getMin();return a.project2D(b+this.SECONDS_PER_DAY).getX()-a.project2D(b).getX()>=this.MIN_SPACING};cr.MidnightLine.prototype.getNextDay=function(a){a=new Date(1E3*a);a.setTime(a.getTime()+this.MILLISECONDS_PER_DAY-1);a.setHours(0);a.setMinutes(0);a.setSeconds(0);return a.getTime()/1E3};"use strict";cr=cr||{};cr.MouseState=function(){this.mouseDown=!1;this.lastMouse=null};cr.MouseState.setLastMouse=function(a){this.lastMouse=a};
cr.MouseState.setIsMouseDown=function(a){this.mouseDown=a};cr.MouseState.isMouseDown=function(){return this.mouseDown};cr.MouseState.getLastMouse=function(){return this.lastMouse};
